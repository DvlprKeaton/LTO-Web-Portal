                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include ("condb.php");
                                              ...
                                              $sql2 = "SELECT * FROM registrationofficialstbl WHERE Status = '1' ORDER BY ID";  
                                              ...
                                              $totalLTO = $numrenewal + $numnew;
                                              echo '<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                LTO Officials</div>';

                                            echo '<div class="h5 mb-0 font-weight-bold text-gray-800">'.$totalLTO.'</div>';?>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include ("condb.php");
                                              ...
                                              $sql = "SELECT * FROM documenttbl WHERE Type = '1' ORDER BY DID";  
                                              $query_run = mysqli_query($cn, $sql);
                                              $row = mysqli_num_rows($query_run);
                                              echo '<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Renewal
                                            </div>';
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include ("condb.php");
                                              ...
                                              $sql = "SELECT * FROM documenttbl WHERE Type = '0' ORDER BY DID";  
                                              $query_run = mysqli_query($cn, $sql);
                                              $row = mysqli_num_rows($query_run);
