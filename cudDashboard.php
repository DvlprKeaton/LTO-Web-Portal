            ...
            <div id="content">
                ...
                <div class="container-fluid" style = "text-align:center">
                    ...
                    <!-- Page Heading -->
                        ...
                        <h1 class="h3 mb-0 text-gray-800">LTO Application</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        New registration is processed thru the liaisons of each car dealer. Liaisons of each car dealer need to go to LTO Offices to submit the initial requirements for each Motor Vehicle/Motorcycle.

                                        <hr>

                                        <form method="POST" action="upNew.php" enctype="multipart/form-data">
                    
                                        <p style="text-align: center; color: black;">Upload the New Registration Application form to confirm application</p>
...
<div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                               Renewal of Registration will be processed by the registered owner of Motor Vehicle/Motorcycle, and They can go to any LTO District Offices near them to process the renewal of their registration

                                        <hr>

                                        <form method="POST" action="upRenewal.php" enctype="multipart/form-data">
                    
                                        <p style="text-align: center; color: black;">Upload the Renewal Application form to confirm application</p>
                                        <div style="text-align: center; color: black;">
                                            <label>
                                              <label for="myfile">Application Form:</label>
                                              <br>
