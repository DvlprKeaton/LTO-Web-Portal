                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include ("condb.php");
                                              ...
                                              $sql = "SELECT * FROM documenttbl WHERE Type = '1' AND EvaluatedDate != null ORDER BY DID";  
                                              $query_run = mysqli_query($cn, $sql);
                                              $row = mysqli_num_rows($query_run);
                                              echo '<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Renewal</div>';
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include ("condb.php");
                                              ...
                                              $sql = "SELECT * FROM documenttbl WHERE Type = '0' AND EvaluatedDate IS NOT NULL ORDER BY DID";  
                                              $query_run = mysqli_query($cn, $sql);
                                              $row = mysqli_num_rows($query_run);
